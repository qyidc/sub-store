# sub-store
# **一个最安全的且功能强大的订阅转换器**
demo [sub.otwx.top](https://sub.otwx.top) 
版本: 1.1 (含详细部署指南)  
日期: 2025年6月9日
...
订阅转换最怕的的就是数据被盗，把节点从别人的网站上走一遭心里总是不踏实，本文档旨在全面阐述“最安全的订阅转换器”项目的技术实现、架构设计与核心功能。作为一个完全部署在Cloudflare全球边缘网络上的无服务器应用，致力于为用户提供一个安全、高效、易用的订阅链接转换与分享解决方案。其核心特点在于**端到端加密**、**自动化部署**以及**极低的运维成本**，本项目完全开源。
...
* **安全分享机制**：  
  ...
  * **端到端加密 (End-to-End Encryption, E2EE)** 模型，即使暂存的后台数据泄露也无法破解。
